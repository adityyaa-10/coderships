        ...
        <div className='w-full flex flex-col items-center bg-[#171717] text-white'>
            <div data-aos="fade-up" data-aos-duration="1500" className="max-w-[1100px] mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row  pt-16">
                    <div className="flex-1 border border-[#4A4B52] py-3 bg-[#25282C] flex flex-col">
                        <span className='px-6 text-[1.4rem] font-semibold'>
                            Demand for Practical Experience
                        </span>
                        <div className="py-3 border-t-0 border-[#D7D7D733]">
                            <hr />
                        </div>
                        <p className='px-6 pr-8 pt-2 leading-[2.5rem] text-[1.125rem] flex-grow'>
                ...
                <div className="bg-[#693ee0] px-6 mt-6 mb-10">
                    <div className="flex flex-col md:flex-row gap-6 py-6">
                        <div className="flex-1 border border-[#4A4B52] py-3 bg-[#171717] flex flex-col">
                            <span className='px-6 text-[1.4rem] font-semibold'>
