    ...
    return (
        <header className="bg-[#1B1B1B] text-white">
            ...
            <div className="items-center justify-center pt-40 lg:pt-[220px] flex flex-col space-y-12 w-full">
                <h1 data-aos="fade-right" data-aos-duration="1500" className={` ${semiBoldFont.className}} text-[30px] leading-[3.2rem] md:text-4xl md:leading-[4rem] lg:text-[3rem] lg:leading-[4.5rem] tracking-wide font-bold max-w-[720px] px-4 text-left md:text-center`}>
