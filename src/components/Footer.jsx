...
const MainFooter = () => {
    return (
        <div>
            ...
            <div className='bg-white flex justify-between px-11 py-4 sm:py-0'>
                <div className="container mx-auto py-4 px-5 flex flex-col sm:flex-row justify-center items-center sm:justify-between">
                    <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M27.1221 19.7917C27.1221 22.3251 25.0613 24.3826 22.5312 24.3826H7.46928C4.93914 24.3826 2.87834 22.325 2.87834 19.7917V10.208C2.87778 9.3915 3.09651 8.58985 3.51168 7.8868L10.861 15.2361C11.9605 16.3388 13.4329 16.9464 15.0018 16.9464C16.5675 16.9464 18.0399 16.3388 19.1394 15.2361L26.4887 7.8868C26.9039 8.58984 27.1226 9.3915 27.122 10.208V19.7917H27.1221ZM22.5312 5.61711H7.46928C6.42443 5.61711 5.45992 5.97072 4.68836 6.55906L12.1116 13.9855C12.88 14.7506 13.9055 15.175 15.0018 15.175C16.0949 15.175 17.1204 14.7506 17.8888 13.9855L25.312 6.55906C24.5405 5.97072 23.5761 5.61711 22.5312 5.61711ZM22.5312 3.8457H7.46928C3.9618 3.8457 1.10693 6.70057 1.10693 10.208V19.7918C1.10693 23.3025 3.9618 26.1541 7.46928 26.1541H22.5312C26.0386 26.1541 28.8935 23.3025 28.8935 19.7918V10.208C28.8935 6.70051 26.0386 3.8457 22.5312 3.8457Z" fill="#544D49" />
                    </svg>

                    <div className="sm:flex py-4 z-50">
                        <Link href={'/terms'} className=" sm:pr-6 text-[#544D49E5]">Terms</Link>
                        <p className="pt-5 sm:pt-0 sm:pr-3 text-[#544D49E5]">Privacy</p>
                    </div>
                </div>
            </div>
        </div>
