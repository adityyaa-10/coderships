        ...
        <div className="flex flex-col justify-center items-center w-full py-8 md:py-16 px-4">
            <div>
                ...
                <div className="border border-[#d7d7d7] max-w-[798px] w-full mx-auto px-4 md:px-10 py-4">
                    <p className="flex gap-3 items-start text-[#544D49E5] text-base md:text-lg leading-relaxed">
                    ...
                    <p className="flex gap-3 items-start text-[#544D49E5] text-base md:text-lg leading-relaxed mt-4">
                        <Image src="https://ik.imagekit.io/internquest/svgexport-14%201-min.svg?updatedAt=1709646013371" alt="" width={24} height={24} className="w-6 h-6 mt-1" />
