...
const Accordion = () => {
  return (
    <div className={`text-[#1B1B1B]`}>
      <div className="bg-[#F4F5F7] py-6 lg:mx-6">
        <div
          className={`margin-[2em] container mx-auto max-w-3xl px-[8px] pt-4 text-black`}
        >
          <div
            data-aos="fade-right"
          ...
          >
            <details>
              <summary className="flex justify-between rounded-xl pl-[11px] pr-2 text-[24px] lg:pl-4">
              ...
              <div className="mr-4 px-2 py-4 text-[1.125rem] leading-[2rem] text-[#1b1b1bce]">
                It's impossible to convey the depth of your skills, creative
                problem-solving abilities, and unique perspective through a
                piece of paper or so called "resume". The most impactful way to
                stand out isn't just telling people what you can do. It's
                showing them what you've built.
              </div>
            </details>
          </div>
          <div
          ...
          >
            <details>
              <summary
                className={`flex justify-between rounded-xl pl-[11px] pr-2 text-[24px] lg:pl-4`}
              >
              ...
              <div className="mr-4 px-2 py-4 text-[1.125rem] leading-[2rem] text-[#1b1b1bce]">
                Being a part of Coderships, you’ll have access to a series of
                virtual internship challenges and real-world project
                inspirations designed to challenge and inspire you to gain the
                work experience you need to succeed.
              </div>
            </details>
          </div>
          <div
          ...
          >
            <details>
              ...
              <div className="mr-4 px-2 py-4 text-[1.125rem] leading-[2rem] text-[#1b1b1bce]">
                Companies are looking for candidates who can hit the ground
                running with practical, hands-on experience. Gaining real-time
                work experience is the most effective way to enhance your
                abilities, acquire valuable new skills, and impress potential
                employers.
              </div>
            </details>
          </div>
          ...
          >
            <details>
              ...
              <div className="mr-4 px-2 py-4 text-[1.125rem] leading-[2rem] text-[#1b1b1bce]">
                Coderships provide a supportive environment where you can
                thrive. Collaborate with peers, receive invaluable support, have
                your code reviewed, and get feedback on your work.
              </div>
            </details>
          </div>
        </div>
