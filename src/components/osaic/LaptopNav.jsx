  ...
  return (
    <>
      <div className="flex items-center gap-x-1.5">
        <svg
          className="[&amp;_path]:transition-colors [&amp;_path]:duration-300 absolute -left-[6px] -top-[15px] hidden lg:block"
        ...
        <a
          className="relative mr-9 hidden h-[50px] items-center transition-all duration-300 lg:flex"
          href="/"
        >
          <span className="sr-only">Osaic</span>
          <div>
            <svg
              className="[&amp;_path]:transition-colors [&amp;_path]:duration-300 -mt-2"
              width="110"
              viewBox="0 0 76 28"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
