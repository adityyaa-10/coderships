    ...
    <header className="absolute inset-x-0 top-0 z-50">
      ...
      >
        <div className="flex items-center gap-x-1.5">
          ...
          <a
            class="relative mr-9 hidden h-[50px] items-center transition-all duration-300 lg:flex"
            href="/"
          >
            <span class="sr-only">Osaic</span>
            <div>
              <svg
                class="[&amp;_path]:transition-colors [&amp;_path]:duration-300 -mt-2"
                width="110"
                viewBox="0 0 76 28"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="relative hidden lg:flex lg:gap-x-1.5">
            ...
            >
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="h-4 w-0 transition-[width] duration-300 ease-in-out group-hover:w-4"
              >
                <path
                  d="M34.5306 13.5C27.2256 13.5 21.3037 7.45584 21.3037 0"
                  stroke="currentColor"
                  strokeWidth="2.5"
                ></path>
                <path
                  d="M21.3033 27.002C21.3033 19.5461 27.2252 13.502 34.5303 13.502"
                  stroke="currentColor"
                  strokeWidth="2.5"
                ></path>
                <path
                  d="M31.8527 13.502L0.5 13.502"
                  stroke="currentColor"
                  strokeWidth="2.5"
                ></path>
              </svg>
        ...
        <div className="hidden h-[50px] items-center rounded-full bg-[#E9E6DC] transition-all duration-300 hover:bg-[#cbfa40] lg:flex">
          <a
            className="font-marselis group flex h-full items-center px-4 uppercase tracking-widest text-[#15535E]"
            target="_self"
            href="/about"
          >
            <span
