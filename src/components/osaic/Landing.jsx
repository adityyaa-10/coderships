const Landing = () => {
  return (
    <div className="relative mx-auto mb-11 max-w-[1500px]">
      <div className="gap-xs prose-animate-in relative z-10 order-2 grid grid-cols-12 px-[20px] lg:px-24">
      ...
      <div className="relative left-0 top-0 order-1 aspect-[1] h-1/2 w-full md:absolute md:m-auto md:h-full">
        <div className="absolute left-0 top-0 h-full w-full md:left-[45%] md:w-1/2">
          <div className="animate-slide-up-in absolute left-0 top-0 h-[48%] w-[15%] [animation-delay:0.2s] md:w-[45%]">
          ...
          <div className="animate-slide-up-in absolute left-[49%] top-0 hidden h-[20%] w-[45%] [animation-delay:0.3s] md:block">
          ...
          <div className="animate-slide-up-in left-initial md:right-initial absolute right-0 top-0 h-[50%] w-[15%] [animation-delay:0.4s] md:left-[98%] md:w-[20%]">
          ...
          <div className="animate-slide-up-in absolute bottom-0 left-0 h-[47%] w-[15%] [animation-delay:0.5s] md:w-[45%]">
          ...
          <div className="animate-slide-up-in absolute left-[20%] top-0 h-[100%] w-[60%] [animation-delay:0.6s] md:left-[49%] md:top-[23%] md:h-[60%] md:w-[45%]">
            <div className="absolute inset-0 size-full overflow-hidden rounded-[13px] md:rounded-[30px]">
              ...
              >
                <source src="https://cdn.sanity.io/files/uozoklvj/production/e593e42c5d117c1c4a170864eb4424eada2ccc8c.mp4" />
              </video>
            </div>
          </div>
          <div className="animate-slide-up-in absolute bottom-0 left-[49%] hidden h-[14%] w-[45%] [animation-delay:0.7s] md:block">
            <div className="absolute inset-0 size-full overflow-hidden rounded-[13px] md:rounded-[30px]">
              <img
                alt=""
                fetchpriority="high"
          ...
          <div className="animate-slide-up-in left-initial md:right-initial absolute bottom-0 right-0 h-[47%] w-[15%] [animation-delay:0.8s] md:left-[98%] md:w-[20%]">
