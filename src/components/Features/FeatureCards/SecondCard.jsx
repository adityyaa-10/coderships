...
const SecondCard = () => {
  return (
    <div className="flex flex-col items-center pt-8 md:pt-16">
      ...
      <div className="mt-8 flex h-auto w-full flex-col md:mt-16 lg:flex-row-reverse">
        <div className="flex w-full flex-col items-center justify-center bg-[#C5EBFF] p-6 text-base text-[#544D49] md:p-9 md:text-lg lg:w-1/2 lg:text-xl">
        ...
        <div className="relative grid h-[500px] w-full grid-cols-5 bg-[#22A5FF] md:h-screen lg:w-1/2">
