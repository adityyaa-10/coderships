    ...
    return (
        <div className="flex flex-col items-center pt-8 md:pt-16">
            ...
            <div className="flex flex-col md:flex-row w-full h-auto mt-8 md:mt-16">
                <div className="w-full md:w-1/2 flex items-center justify-center text-base md:text-lg lg:text-xl flex-col  text-[#544D49] bg-[#FFD5D2] p-6 md:p-9 ">
                ...
                <div className="w-full md:w-1/2 bg-[#FF553D] grid grid-cols-5 relative h-[500px] md:h-screen">
