        ...
        <div className="max-w-screen-lg mx-auto">
            ...
            <div className="border border-[#D9D9D9] relative">
                ...
                <div className="pt-16 pb-8 px-4 lg:p-32">
                    <p className='px-4 text-[1rem] leading-[2rem] lg:text-[20px] lg:leading-[2.5rem] text-[#2D2323]'> Let's face it – it's tough to convey the depth of your coding skills on a resume. Traditional
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                <div className="border border-[#D9D9D9] border-t-0 relative px-4 py-6 lg:py-32 flex-1">
                    ...
                    <div className='lg:p-8'>
                        <p className='px-4 text-[1rem] leading-[2rem] lg:text-[20px] lg:leading-[2.5rem] text-[#2D2323]'>Your code tells a story – your story. It's not just
