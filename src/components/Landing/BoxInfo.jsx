    ...
    return (
        <div data-aos="fade-up" data-aos-duration="1500" className="max-w-screen-lg mx-auto">
            ...
            <div className="border border-[#D9D9D9] relative">
                ...
                <div className="absolute block bottom-0 left-0 w-[70px] h-[30px] lg:w-[130px] lg:h-[50px] border border-[#D9D9D9] border-l-0 border-b-0" />
            </div>
            ...
            <div className="flex flex-col lg:flex-row">
                ...
                {/* Left Block */}
                <div className="border border-[#D9D9D9] border-t-0 relative px-4 md:px-12  py-6 lg:py-32 flex-1">
                    ...
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 block w-[70px] h-[30px] lg:hidden border border-[#D9D9D9] border-t-0" />
                    <div className="absolute bottom-0 left-0 block w-[30px] h-[30px] lg:hidden border border-[#D9D9D9] border-b-0" />
                </div>

                {/* Right Block */}
                <div className="border border-[#D9D9D9] border-t-0 lg:border-l-0 relative px-4 md:px-12 py-6 lg:py-32 flex-1">
                    ...
                    <div className="absolute block top-0 right-0 w-[30px] h-[120px] lg:hidden border border-[#D9D9D9] border-t-0" />
                </div>
            </div>
        </div>
    );
