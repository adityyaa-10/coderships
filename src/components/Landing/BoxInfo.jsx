    ...
    return (
        <div className="container mx-auto p-4">
            ...
            <div className="border border-[#D9D9D9] relative">
                ...
                <div className="absolute top-0 bottom-0 right-12 w-[1px] bg-[#D9D9D9]" />
                <div className="p-16 lg:p-32">
                    <p className='text-[1rem] leading-[2rem] lg:text-[1.5rem] lg:leading-[3rem] text-[#2D2323] font-medium'> Let's face it – it's tough to convey the depth of your coding skills on a resume. Traditional
