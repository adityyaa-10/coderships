...
const Vision = () => {
    return (
        <div data-aos="fade-up" data-aos-duration="1500" className="max-w-[1200px] px-3 md:px-12 lg:px-3 mx-auto py-8 lg:py-14 flex flex-col sm:flex-row">
            ...
            <div className="p-4 lg:p-10 border border-[#d7d7d783] w-full sm:w-[72%] mt-6  sm:mt-0 sm:ml-11 max-w-[731px]">
                <p className="text-[#544D49] text-[1.1rem] leading-[2.3rem] lg:text-[1.2rem] lg:leading-[2.5rem]">
